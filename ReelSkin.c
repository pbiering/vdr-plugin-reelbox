...
namespace Reel
{
   ...
   enum
   {
                              ...
                              int img1Width, int img3Width)
    {
        ...
        osd->DrawHdImage(img1, l, t, false);
        osd->DrawHdImage(img2, l + img1Width, t, false, count);
        osd->DrawHdImage(img3, r - img3Width, t, false);
    }
...
void DrawUnbufferedImage(cOsd* osd, std::string imgName, int xLeft, int yTop, int blend, int horRep=1, int vertRep=1)
{
  ...
  osd->DrawHdImage(imgUnbufferedEnum, xLeft, yTop, blend, horRep, vertRep);
}
    ...
    {
        osd->DrawHdImage(img_a_top_left, x0, y0, false);
        osd->DrawHdImage(img_a_top_border, x0_1, y0, false, x6 - x0_1);
        osd->DrawHdImage(img_a_top_right, x6, y0, false);

        osd->DrawHdImage(img_a_bottom_left, x0, y2, false);
        osd->DrawHdImage(img_a_bottom_border, x0_1, y2, false, x6 - x0_1);
        osd->DrawHdImage(img_a_bottom_right, x6, y2, false);

        osd->DrawHdImage(img_pre_top_left, x0, y2_1, false);
        osd->DrawHdImage(img_pre_top_border, x0_1, y2_1, false, x1 - x0_1);
        osd->DrawHdImage(img_b_top_border, x1, y2_1, false, x6 - x1);
        osd->DrawHdImage(img_b_top_right, x6, y2_1, false);

        osd->DrawHdImage(img_pre_border_left, x0, y3, false, 1, y4 - y3);
        ...
        osd->DrawHdImage(img_b_border_right, x6, y3, false, 1, y4 - y3);
    }

    void ReelSkinDisplayChannel::DrawLowerBarBkgnd()
    {
        osd->DrawHdImage(img_c_top_left, x0, y5, false);
        osd->DrawHdImage(img_c_top_border, x0_1, y5, false, x6 - x0_1);
        osd->DrawHdImage(img_c_top_right, x6, y5, false);

        osd->DrawHdImage(img_c_bottom_left, x0, y6, false);
        osd->DrawHdImage(img_c_bottom_border, x0_1, y6, false, x6 - x0_1);
        osd->DrawHdImage(img_c_bottom_right, x6, y6, false);

        osd->DrawHdImage(imgSignal, xsSignalImg, y5 + 13, true);
    }

    void ReelSkinDisplayChannel::DrawLowerBorder()
    {
        osd->DrawHdImage(img_pre_bottom_left, x0, y4, false);
        osd->DrawHdImage(img_pre_bottom_border, x0_1, y4, false, x1 - x0_1);
        osd->DrawHdImage(img_b_bottom_border, x1, y4, false, x6 - x1);
        osd->DrawHdImage(img_b_bottom_right, x6, y4, false);
    }
    ...
    void ReelSkinDisplayChannel::SetChannel(const cChannel *Channel, int Number)
    {
        ...
        if (Channel && !Channel->GroupSep())
        {
            ...
            osd->DrawHdImage(rec ? imgRecordingOn : imgRecordingOff, x, y, true);

            x -= imgChannelInfoIconWidth + d;
            osd->DrawHdImage(ca ? imgEncryptedOn : imgEncryptedOff, x, y, true);

            x -= imgChannelInfoIconWidth + d;
            osd->DrawHdImage(Channel->Dpid(0) ? imgDolbyDigitalOn : imgDolbyDigitalOff, x, y, true);

            x -= imgChannelInfoIconWidth + d;
            osd->DrawHdImage(Channel->Apid(1) ? imgAudioOn : imgAudioOff, x, y, true);

            if (Channel->Vpid())
            {
                x -= imgChannelInfoIconWidth + d;
                osd->DrawHdImage(Channel->Tpid() ? imgTeletextOn : imgTeletextOff, x, y, true);
            }
            else if (Channel->Apid(0))
            {
                x -= imgChannelInfoIconWidth + d;
                osd->DrawHdImage(Channel->Tpid() ? imgRadio : imgTeletextOff, x, y, true);
            }
            ...
            osd->DrawHdImage(imgCa, x, y, true);
        }
    ...
    void ReelSkinDisplayChannel::SetMessage(eMessageType type, const char *text)
    {
        if (text)
        {
            ...
            osd->DrawHdImage(imgId, x0, y, true);
            osd->DrawHdImage(imgId + 1, xs, y, true, xe - xs);
            osd->DrawHdImage(imgId + 2, xe, y, true);
    ...
    void ReelSkinDisplayChannel::Update43()
    {
        if (x43)
        {
            osd->DrawHdImage(img_a_top_border, x43, y0, false, img43IconWidth);
            osd->DrawHdImage(img_a_bottom_border, x43, y2, false, img43IconWidth);
...
//         printf ("\033[0;41m aspect.h = %i \033[0m\n", HdCommChannel::hda->video_mode.aspect.h );
            ...
            if (width > 0 || height > 0)
                osd->DrawHdImage((width == 16 && height == 9) ? img169 : img43, x43, y0 + imgTopHeight - imgChannelInfoIconHeight / 2, true);
        }
    }
    ...
    void ReelSkinDisplayChannel::UpdateDateTime()
    {
        ...
        if (dateTime != implicit_cast<char const *>(dt))
        {
            ...
            osd->DrawHdImage(img_c_top_border, xsDateTime, y5, false, xeDateTime - xsDateTime);
            osd->DrawHdImage(img_c_bottom_border, xsDateTime, y6, false, xeDateTime - xsDateTime);
    ...
    void ReelSkinDisplayChannel::UpdateTrackDescription()
    {
        ...
        if (track && trackDesc != track->description)
        {
            ...
            osd->DrawHdImage(img_c_top_border, xsTrackDesc, y5, false, xeTrackDesc - xsTrackDesc);
            osd->DrawHdImage(img_c_bottom_border, xsTrackDesc, y6, false, xeTrackDesc - xsTrackDesc);
    ...
    void ReelSkinDisplayChannel::UpdateSignalStrength()
    {
        ...
        if (str != strBarWidth || snr != snrBarWidth)
        {
            ...
            int ySnr = y + 6;
            int h = 6;
            osd->DrawHdImage(img_c_top_border, xsSignalBar, y5, false, xeSignalBar - xsSignalBar);
            osd->DrawHdImage(img_c_bottom_border, xsSignalBar, y6, false, xeSignalBar - xsSignalBar);
    ...
    void ReelSkinDisplayChannel::UpdateTuners()
    {
        for (int n = 0; n < numTuners; ++n)
        {
            ...
            if (tuners[n].imgId != imgId)
            {
                ...
                osd->DrawHdImage(img_c_top_border, tuners[n].xs, y5, false, tuners[n].xe - tuners[n].xs);
                osd->DrawHdImage(img_c_bottom_border, tuners[n].xs, y6, false, tuners[n].xe - tuners[n].xs);
                osd->DrawHdImage(imgId, tuners[n].xs, y5_1 + 3, true);
            }
        }
    }
    ...
    void ReelSkinMenu::DrawButton(UInt imgButton1, int x, int width)
    {
        ...
        osd->DrawHdImage(imgButton1, x, y, true);
        osd->DrawHdImage(imgButton1 + 1, x + imgButton1Width, y, true, width - imgButton1Width - imgButton3Width);
        osd->DrawHdImage(imgButton1 + 2, x + width - imgButton3Width, y, true);
    }
    ...
    void ReelSkinMenu::DrawTitleBar()
    {
        ...
        {
          osd->DrawHdImage(imgSymbol, x0 + imgLeftWidth, y0 + 5, true);
        }
        osd->DrawHdImage(img_b_border_left, x0, y2, false, 1, symbolOffset);
        osd->DrawRectangle(x1, y2, x6 - 1, y2 + symbolOffset - 1, themeClrBackground);
        osd->DrawHdImage(img_b_border_right, x6, y2, false, 1, symbolOffset);
    }
    ...
    ReelSkinMenu::ReelSkinMenu()
    {
        ...
        Draw3TilesHor(osd, img_b_bottom_left, img_b_bottom_border, img_b_bottom_right, x0, y1, x7,
                      imgLeftWidth, imgRightWidth);
        osd->DrawHdImage(img_b_border_left, x0, y2 + symbolOffset, false, 1, y6 - y2);
        osd->DrawRectangle(x1, y2 + symbolOffset, x6 - 1, y6 - 1, themeClrBackground);
        osd->DrawHdImage(img_b_border_right, x6, y2 + symbolOffset, false, 1, y6 - y2);
    ...
    // If ScroolBar needed?
        if (textScroller.CanScroll()) {
            ...
            {
                osd->DrawHdImage(img_arrow_up, xright, ScrollTop, true);
            }
            else  // clear arrow_up
            {
            ...
            {
                osd->DrawHdImage(img_arrow_down, xright, ScrollBottom, true);
            }
    ...
    {
        textScroller.Reset();
        osd->DrawHdImage(img_b_border_left, x0, y2 + symbolOffset, false, 1, y6 - y2 - symbolOffset);
        osd->DrawRectangle(x1, y2 + symbolOffset, x6 - 1, y5 - 1, themeClrBackground);
        osd->DrawHdImage(img_b_border_right, x6, y2 + symbolOffset, false, 1, y6 - y2 - symbolOffset);
    }
...
#define HIDDENSTRING "menunormalhidden$"
    ...
    void ReelSkinMenu::SetMessage(eMessageType type, const char *text)
    {
        ...
        if (text)
        {
            ...
            case mtStatus:
                if (strcmp(text, "(?)") == 0)
                {
                    osd->DrawHdImage(img_b_border_left, x0, y4, false, 1, y5 - y4);
                    osd->DrawRectangle(x1, y4, x6 - 1, y5  - 1, themeClrBackground);
                    osd->DrawHdImage(img_b_border_right, x6, y4, false, 1, y5 - y4);
                    osd->DrawHdImage(imgQuestionmark, x6 - imgQuestionmarkWidth, y4, true);
                }
                else
                {
                    osd->DrawHdImage(img_status_border_left, x0, y4, false, 1, y5 - y4);
                    osd->DrawRectangle(x1, y4, x6 - 1, y5  - 1, themeClrMessageStatusBg);
                    osd->DrawHdImage(img_status_border_right, x6, y4, false, 1, y5 - y4);
                    //osd->DrawText(x1, y4, text, themeClrMessageStatusFg, clrTransparent, font, x6 - x1, 0, taCenter);
                    color = themeClrMessageStatusFg;
                }
                break;
            case mtWarning:
                osd->DrawHdImage(img_warning_border_left, x0, y4, false, 1, y5 - y4);
                osd->DrawRectangle(x1, y4, x6 - 1, y5  - 1, themeClrMessageWarningBg);
                osd->DrawHdImage(img_warning_border_right, x6, y4, false, 1, y5 - y4);
                //osd->DrawText(x1, y4, text, themeClrMessageWarningFg, clrTransparent, font, x6 - x1, 0, taCenter);
                color = themeClrMessageWarningFg;
                break;
            case mtError:
                osd->DrawHdImage(img_error_border_left, x0, y4, false, 1, y5 - y4);
                osd->DrawRectangle(x1, y4, x6 - 1, y5  - 1, themeClrMessageErrorBg);
                osd->DrawHdImage(img_error_border_right, x6, y4, false, 1, y5 - y4);
                //osd->DrawText(x1, y4, text, themeClrMessageErrorFg, clrTransparent, font, x6 - x1, 0, taCenter);
                color = themeClrMessageErrorFg;
                break;
            default:
                osd->DrawHdImage(img_info_border_left, x0, y4, false, 1, y5 - y4);
                osd->DrawRectangle(x1, y4, x6 - 1, y5  - 1, themeClrMessageInfoBg);
                osd->DrawHdImage(img_info_border_right, x6, y4, false, 1, y5 - y4);
    ...
    void ReelSkinMenu::SetItem(char const *text, int Index, bool Current, bool Selectable)
    {
        ...
        if (Current)
        {
            osd->DrawHdImage(img_pre_border_left, x0, y, false, 1, lineHeight);
            osd->DrawHdImage(img_pre_border_right, x6, y, false, 1, lineHeight);
            // osd->DrawHdImage(imgHighline1, x0, y, true, 1, lineHeight);
            // osd->DrawHdImage(imgHighline3, x7 - imgHighline3Width, y, true, 1, lineHeight);
            osd->DrawRectangle(x1, y, x6 - 1, y + lineHeight - 1, themeClrPreBackground);
            osd->DrawHdImage(imgMarker, x0 + 8, y, true);
        }
        else
        {
            osd->DrawHdImage(img_b_border_left, x0, y, false, 1, lineHeight);
            osd->DrawRectangle(xs, y, xe - 1, y + lineHeight - 1, themeClrBackground);
            osd->DrawHdImage(img_b_border_right, x6, y, false, 1, lineHeight);
        }
      ...
      if (iseventinfo) {
        ...
        for (; *p; ++p) {
          switch (*p) {
            case 't':
              // partial timer event
              osd->DrawHdImage(imgIconTimerpart, evx, y + 1, true);
              evx += IMGICONWIDTH;
              *p = ' ';
              break;
            case 'T':
              // timer event
              osd->DrawHdImage(imgIconTimer, evx, y + 1, true);
              evx += IMGICONWIDTH;
              *p = ' ';
              break;
            case 'R':
              // recording event (epgsearch)
              osd->DrawHdImage(imgIconRecord, evx, y + 1, true);
              evx += IMGICONWIDTH;
	      *p = ' ';
              break;
            case 'V':
              // vps event
              osd->DrawHdImage(imgIconVps, evx, y + 1, true);
              evx += IMGICONWIDTH;
	      *p = ' ';
              break;
            case 'S':
              osd->DrawHdImage(imgIconZappingtimer, evx, y + 1, true);
              evx += IMGICONWIDTH;
              *p = ' ';
              break;
            case '*':
              // running event
//              osd->DrawHdImage(imgIconRunningnow, evx, y + 1, true);
//              evx += IMGICONWIDTH;
              *p = ' ';
              break;
            case ' ':
        ...
        if (isarchived)
        {
          osd->DrawHdImage(imgIconArchive, xt + cFont::GetFont(fontOsd)->Width(s), y + 1, true);
          if (isnewrecording)
            osd->DrawHdImage(imgIconNewrecording, xt + cFont::GetFont(fontOsd)->Width(s) + IMGICONWIDTH, y + 1, true);
        } else
          osd->DrawHdImage(imgIconNewrecording, xt + cFont::GetFont(fontOsd)->Width(s), y + 1, true);
...
#define PROGRESSBARHEIGHT  7
        ...
        {
          case ePinProtect:
            osd->DrawHdImage(imgIconPinProtect, xt, y + 1, true);
            break;
          case eArchive:
            osd->DrawHdImage(imgIconArchive, xt, y + 1, true);
            break;
          case eBack:
            osd->DrawHdImage(imgIconFolderUp, xt, y + 1, true);
            xt += 20;
            ...
            break;
          case eFolder:
            osd->DrawHdImage(imgIconFolder, xt, y + 1, true);
            break;
          case eNewrecording:
            osd->DrawHdImage(imgIconNewrecording, xt, y + 1, true);
            break;
          case eCut:
            osd->DrawHdImage(imgIconCut, xt, y + 1, true);
            break;
          case eNewCut:
            osd->DrawHdImage(imgIconNewrecording, xt, y + 1, true);
            osd->DrawHdImage(imgIconCut, xt+IMGICONWIDTH, y + 1, true);
            break;
          case eArchivedCut:
            osd->DrawHdImage(imgIconArchive, xt, y + 1, true);
            osd->DrawHdImage(imgIconCut, xt+IMGICONWIDTH, y + 1, true);
            break;
          case eRecord:
            osd->DrawHdImage(imgIconRecord, xt, y + 1, true);
            break;
          case eTimeractive:
            osd->DrawHdImage(imgIconTimeractive, xt, y + 1, true);
            break;
          case eSkipnextrecording:
            osd->DrawHdImage(imgIconSkipnextrecording, xt, y + 1, true);
            break;
          case eNetwork:
          ...
          case eMusic:
            ...
            break;
          case eRunningNow:
            osd->DrawHdImage(imgIconRunningnow, xt, y + 1, true);
            break;
          default:
            break;
        }
        ...
        if (isHD) {
          osd->DrawHdImage(imgIconHd, xt, y + 1, true);
          xt += 20;
        } else if (isFavouriteFolder) {
          osd->DrawHdImage(imgIconFavouriteFolder, xt, y + 1, true);
          xt += 20;
        } else if (isFolder) {
          osd->DrawHdImage(imgIconFolder, xt, y + 1, true);
          xt += 20;
    ...
    void ReelSkinDisplayReplay::DrawMessage()
    {
        ...
        case mtStatus:
            imgId = imgButtonGreen1;
            osd->DrawHdImage(imgId, x1, y6, false);
            osd->DrawHdImage(imgId + 1, x2, y6, false, x3 - x2);
            osd->DrawHdImage(imgId + 2, x3, y6, false);
    ...
    void ReelSkinDisplayReplay::DrawBottomBar()
    {
        ...
        else
        {
            ...
            if (!modeOnly)
            {
                ...
                osd->DrawHdImage(img_c_top_left, x1, y5, false);
                osd->DrawHdImage(img_c_top_border, x2, y5, false, x3 - x2);
                osd->DrawHdImage(img_c_top_right, x3, y5, false);

                osd->DrawHdImage(img_c_bottom_left, x1, y9, false);
                osd->DrawHdImage(img_c_bottom_border, x2, y9, false, x3 - x2);
                osd->DrawHdImage(img_c_bottom_right, x3, y9, false);
    ...
    void ReelSkinDisplayReplay::DrawCurrent()
    {
        if (lastCurrentWidth)
        {
            osd->DrawHdImage(img_c_top_border, x2, y5, false, lastCurrentWidth);
            osd->DrawHdImage(img_c_bottom_border, x2, y9, false, lastCurrentWidth);
        }
    ...
    void ReelSkinDisplayReplay::DrawMode()
    {
        ...
        osd->DrawHdImage(imgTrick, x, y, true);
        if (modeImgId >= 0)
        {
            osd->DrawHdImage(modeImgId, xs, ys, true);
        }
    }
    ...
    void ReelSkinDisplayReplay::DrawTotal()
    {
        if (lastTotalWidth)
        {
            ...
            osd->DrawHdImage(img_c_top_border, x, y5, false, lastTotalWidth);
            osd->DrawHdImage(img_c_bottom_border, x, y9, false, lastTotalWidth);
        }
    ...
    {
        osd->DrawHdImage(img_a_top_left, x1, y0, false);
        osd->DrawHdImage(img_a_top_border, x2, y0, false, x3 - x2);
        osd->DrawHdImage(img_a_top_right, x3, y0, false);

        osd->DrawHdImage(img_a_bottom_left, x1, y3, false);
        osd->DrawHdImage(img_a_bottom_border, x2, y3, false, x3 - x2);
        osd->DrawHdImage(img_a_bottom_right, x3, y3, false);
    ...
    void ReelSkinDisplayVolume::SetVolume(int Current, int Total, bool Mute)
    {
        ...
        if (Mute)
        {
            osd->DrawHdImage(imgMute, x0, y0, false);
        }
        else
        {
            int x2_1 = x2 + (x3 - x2) * Current / Total;
            osd->DrawHdImage(img_pre_top_left, x0, y0, false);
            osd->DrawHdImage(img_pre_top_border, x1, y0, false, x2_1 - x1);
            osd->DrawHdImage(img_a_top_border, x2_1, y0, false, x3 - x2_1);
            osd->DrawHdImage(img_a_top_right, x3, y0, false);

            osd->DrawHdImage(img_pre_border_left, x0, y1, false);
            osd->DrawHdImage(img_pre_border_right, x3, y1, false);

            osd->DrawHdImage(img_pre_bottom_left, x0, y2, false);
            osd->DrawHdImage(img_pre_bottom_border, x1, y2, false, x2_1 - x1);
            osd->DrawHdImage(img_a_bottom_border, x2_1, y2, false, x3 - x2_1);
            osd->DrawHdImage(img_a_bottom_right, x3, y2, false);

            osd->DrawHdImage(imgVolume, x1 - 4, y1 - imgVolumeHeight / 2, true);
    ...
    ReelSkinDisplayTracks::ReelSkinDisplayTracks(const char *title, int numTracks, char const *const *tracks)
    {
        ...
        osd->DrawHdImage(img_a_top_left, x0, y0, false);
        osd->DrawHdImage(img_a_top_border, x1, y0, false, x5 - x1);
        osd->DrawHdImage(img_a_top_right, x5, y0, false);
        osd->DrawHdImage(img_a_bottom_left, x0, y3, false);
        osd->DrawHdImage(img_a_bottom_border, x1, y3, false, x5 - x1);
        osd->DrawHdImage(img_a_bottom_right, x5, y3, false);

        osd->DrawText(x4, y1, title, Theme.Color(clrMainText), clrTransparent, font);

        osd->DrawHdImage(img_b_top_left, x0, y4, false);
        osd->DrawHdImage(img_b_top_border, x1, y4, false, x5 - x1);
        osd->DrawHdImage(img_b_top_right, x5, y4, false);
        osd->DrawHdImage(img_b_border_left, x0, y5, false, 1, y6 - y5);

        osd->DrawHdImage(img_b_border_right, x5, y5, false, 1, y6 - y5);
        osd->DrawHdImage(img_b_bottom_left, x0, y6, false);
        osd->DrawHdImage(img_b_bottom_border, x1, y6, false, x5 - x1);
        osd->DrawHdImage(img_b_bottom_right, x5, y6, false);
    ...
    void ReelSkinDisplayTracks::SetTrack(int index, char const *const *tracks)
    {
        ...
        for (int n = 0; n < numTracks_; ++n)
        {
            ...
            {
                osd->DrawHdImage(img_pre_border_left, x0, y, false, 1, lineHeight);
                osd->DrawHdImage(img_pre_border_right, x5, y, false, 1, lineHeight);
                // osd->DrawHdImage(imgHighline1, x0, y, true, 1, lineHeight);
                // osd->DrawHdImage(imgHighline3, x6 - imgHighline3Width, y, true, 1, lineHeight);
            ...
            {
                osd->DrawHdImage(img_b_border_left, x0, y, false, 1, lineHeight);
                osd->DrawHdImage(img_b_border_right, x5, y, false, 1, lineHeight);
            }
    ...
    {
        osd->DrawHdImage(img_c_top_left, x0, y7, false);
        osd->DrawHdImage(img_c_top_border, x1, y7, false, x5 - x1);
        osd->DrawHdImage(img_c_top_right, x5, y7, false);
        osd->DrawHdImage(img_c_bottom_left, x0, y10, false);
        osd->DrawHdImage(img_c_bottom_border, x1, y10, false, x5 - x1);
        osd->DrawHdImage(img_c_bottom_right, x5, y10, false);
        ...
        if (imgId >= 0)
        {
            osd->DrawHdImage(imgId, x4, y8, true);
        }
    }
    ...
    void ReelSkinDisplayMessage::SetMessage(eMessageType Type, const char *Text)
    {
        ...
        osd->DrawHdImage(imgId, x0, y0, false);
        osd->DrawHdImage(imgId + 1, x1, y0, false, x2 - x1);
        osd->DrawHdImage(imgId + 2, x2, y0, false);
